...
var SITE_CONFIG = {
  ...
  faq: {
    ...
    items: [
      { q: "¿Qué significa efectivizar mi tarjeta?", a: "Es convertir la línea disponible de tu tarjeta de crédito en dinero depositado en tu cuenta bancaria. Pagas una comisión mucho menor que la de una disposición de efectivo o un retiro en cajero. Además, si lo necesitas, te asesoramos gratis para conseguir préstamos con mejores condiciones." },
